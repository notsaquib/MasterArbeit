...
DATASET_TAG = "MA52_MMAct_PKU"  # Change this depending on the datasets used
...
def main():
    ...
    model_path = f"action_prediction_baseline/models/rf_{DATASET_TAG}_TestAcc_{test_acc}_ValAcc_{val_acc}_{save_time}.pkl"
